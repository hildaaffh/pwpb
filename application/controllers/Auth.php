...
class Auth extends CI_Controller
{
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config['smtp_user'] = 'hildaanuraafifah@gmail.com'; //email yang dirubah keamanannya
        $config['smtp_pass'] = 'cqrlarrvtrxbbioy'; //isikan passsword dari kelola akun gmail
        $config['smtp_port'] = '465';
        $config['malltype'] = 'html';
        $config['charset'] = 'utf-8';
        $config['newline'] = "\r\n";
        $this->email->initialize($config);
        $this->email->from('hildaanuraafifah@gmail.com', 'Ayang Hilda');
